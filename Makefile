...
goimports: FORCE
	@printf "\e[1;36m>> goimports -w -local https://github.com/sapcc/go-api-declarations\e[0m\n"
	@goimports -w -local https://github.com/sapcc/go-api-declarations internal/ $(patsubst $(shell awk '$$1 == "module" {print $$2}' go.mod)%,.%/*.go,$(shell go list ./...))
